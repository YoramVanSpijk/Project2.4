...
void VisionCamera::calculateTresholds()
{
...
void VisionCamera::createSettingsWindow()
{
...
void VisionCamera::applyTransformations()
{
...
void VisionCamera::calculateNewPoint(std::vector<cv::KeyPoint> keypoints, int i)
{
